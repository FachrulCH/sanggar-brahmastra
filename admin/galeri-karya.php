...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Karya Semua Guru Sanggar</h1>
                </div><!-- /.col -->
            </div>
            <div class="row">
                <?php
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="card-footer text-muted">
                                        <a href="karya-editor.php?id=<?= $karya['id'] ?>&guru=<?= $karya['id_guru'] ?>" class="btn btn-primary float-left"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
